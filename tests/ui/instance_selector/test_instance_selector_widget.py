...
from .test_vortex_selector_widget import PROFILE_DROPDOWN


class TestInstanceSelectorWidget(BaseTest):
    """
    Tests `ui.instance_selector.instance_selector_widget.InstanceSelectorWidget`.
    """
    ...
    @pytest.fixture
    def widget(
        self, test_fs: FakeFilesystem, full_vortex_db: MockPlyvelDB, qtbot: QtBot
    ) -> InstanceSelectorWidget:
        """
        ...
        instance_selector_widget.set_cur_game(GameService.get_game_by_id("skyrimse"))
    ...
    def assert_initial_state(self, widget: InstanceSelectorWidget) -> None:
        ...
        assert mod_manager_dropdown.getCurrentValue() is None
    ...
    # TODO: Fix this test
    # @pytest.mark.skip(
    #     reason="Qt signals aren't properly emitted in EnumPlaceholderDropdown"
    # )
    ...
    def test_change_instance(
        ...
        vortex_profile_dropdown: QComboBox = Utils.get_private_field(
            vortex_selector_widget, *PROFILE_DROPDOWN
        )
